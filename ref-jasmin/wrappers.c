...
void compute_root_jasmin(uint8_t *root, const uint8_t *leaf, uint32_t leaf_idx,
...
extern void hash_message_jazz(uint8_t *digest, uint64_t *tree,
                              uint32_t *leaf_idx, const args *_args,
                              const uint8_t *msg, size_t msg_len);

void hash_message_jasmin(uint8_t *digest, uint64_t *tree, uint32_t *leaf_idx,
                         const uint8_t *R, const uint8_t *pk, const uint8_t *m,
                         size_t mlen, const spx_ctx *ctx) {}
#endif
